...
import com.omniapps.vitalsense5.views.AboutDialogFragment;
import com.omniapps.vitalsense5.views.GraphFragment;
import com.omniapps.vitalsense5.views.HealthVaultFragment;
import com.omniapps.vitalsense5.views.InputFragment;
import com.omniapps.vitalsense5.views.LogOutFragment;
import com.omniapps.vitalsense5.views.ResultsFragment;
...
public class MainActivity extends ActionBarActivity implements NavigationDrawerCallbacks {
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position) {
			...
			case 3:
				newFragment = new HealthVaultFragment();
				args.putInt(HealthVaultFragment.ARG_MENU_ITEM_NUMBER, position);
				break;
